    ...
    <div class="order-menu mt-4">
        <div class="row m-0 text-center">
            ...
            <div class="col pb-2 border-success border-bottom">
                <a href="{{route('complete_transaction')}}"
                    class="text-success fw-bold text-decoration-none">Completed</a>
            </div>
            <div class="col pb-2 border-bottom">
        ...
        <div class="pb-3">
            ...
            <a href="{{route('show_transaction',['id'=>Crypt::encryptString($item->id_transaction)])}}"
                ...
                <div class="p-3 rounded shadow-sm bg-white">
                    <div class="d-flex align-items-center">
                        <p class="bg-primary text-white py-1 px-2 rounded small m-0 text-capitalize">
                            {{@$item->users->name}}</p>
                    ...
                    <div class="d-flex align-items-center">
                         <p class="text-muted ms-auto small m-0"><i class="icofont-ui-check text-success"></i>
                             {{date('d-m-Y  H:m',strtotime($item->updated_at))}}</p>
                    </div>
