    ...
    <div class="order-menu mt-4">
        <div class="row m-0 text-center">
            <div class="col pb-2 border-success border-bottom">
                <a href="{{route('on_progress_transaction')}}" class="text-success fw-bold text-decoration-none">On Progress</a>
            </div>
            ...
            <a href="{{route('show_transaction',['id'=>Crypt::encryptString($item->id_transaction)])}}" class="text-decoration-none text-dark m-1">
                <div class="p-3 rounded shadow-sm bg-white">
                    <div class="d-flex align-items-center mb-3">
                        <p class="bg-warning text-white py-1 px-2 rounded small m-0 text-capitalize">{{@$item->users->name}}</p>
