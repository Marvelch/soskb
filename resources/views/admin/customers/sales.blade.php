...
<div class="container-fluid">
    ...
    <div class="row">
        <div class="col-xl-8 col-lg-7">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="{{route('admin.store.sales.customer',['id'=>Crypt::encryptString($customers->id)])}}"
                        method="post">
                        @csrf
                        <p class="text-muted small">Mohon diperhatikan bahwa customer {{@$customers->name}}
